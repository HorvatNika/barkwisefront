...
export default {
  ...
  methods: {
    ...
    async addEvent() {
      ...
      try {
        const response = await axios.post('http://localhost:3000/schedule', newEvent);
    ...
    async updateEvent(event) {
      try {
        ...
        await axios.put(`http://localhost:3000/schedule/${event.id}`, updatedEvent);
    ...
    async deleteEvent(event) {
      try {
        await axios.delete(`http://localhost:3000/schedule/${event.id}`);
