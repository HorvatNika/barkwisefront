  ...
  <div class="quiet-training">
    <div class="title-box">
      ...
      <div class="content">
        ...
        <ol>
          <li><strong>Identify the Cause of Barking:</strong> Understand what triggers your dog's barking to apply the right approach.</li>
          <li><strong>Establish Yourself as the Leader:</strong> Show calm, assertive leadership to help your dog feel secure.</li>
          <li><strong>Correct Barking Immediately:</strong> Use gentle touch to interrupt barking and redirect attention.</li>
          <li><strong>Avoid Reinforcing Fear:</strong> Don’t comfort your dog during fearful barking—remain calm and neutral.</li>
          <li><strong>Consistency and Patience:</strong> Be consistent with correction, and patient with progress.</li>
        </ol>
