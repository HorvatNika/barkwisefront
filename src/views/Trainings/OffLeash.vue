  ...
  <div class="off-leash">
    <div class="title-box">
      ...
      <div class="content">
        ...
        <ol>
          <li>
            <strong>Achieving Perfect Leash Control:</strong> Ensure your dog obeys commands perfectly while on a leash.
          </li>
          <li>
            <strong>On-Leash Training as Preparation:</strong> Reinforce behavior with corrections and rewards.
          </li>
          <li>
            <strong>Transitioning to a Dropped Leash:</strong> Let the leash trail while still holding it, simulating off-leash.
          </li>
          <li>
            <strong>Fake Leash Removal:</strong> Pretend to remove the leash to teach your dog to remain by your side.
          </li>
          <li>
            <strong>Actual Leash Removal:</strong> Try this only after your dog consistently responds with leash on and off.
          </li>
        </ol>
        ...
        <div class="training-tips">
          ...
          <ul>
            <li><strong>Safety First:</strong> Never let your dog off-leash near roads or dangerous areas.</li>
            <li><strong>Consistency and Patience:</strong> Training takes time and repetition.</li>
            <li><strong>Leash Regulations:</strong> Be aware of local laws regarding leash use.</li>
          </ul>
        </div>
      </div>
    </div>
