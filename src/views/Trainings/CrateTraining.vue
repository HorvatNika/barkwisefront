  ...
  <div class="crate-training">
    <div class="title-box">
      ...
      <div class="content">
        ...
        <ol>
          <li><strong>Familiarization:</strong> Place the crate in a visible spot... </li>
          <li><strong>Positive Associations:</strong> Toss treats into the crate...</li>
          <li><strong>Offer Game:</strong> Let the dog enter the crate to get the treat...</li>
          <li><strong>Feeding:</strong> Feed in the crate with the door open, then close it...</li>
          <li><strong>Short Stays:</strong> Start with short periods and increase gradually...</li>
          <li><strong>Different Locations:</strong> Move crate around to different rooms...</li>
          <li><strong>Calm Exits:</strong> Wait for calm before letting dog out...</li>
          <li><strong>Freedom:</strong> Gradually allow more time outside the crate...</li>
        </ol>
