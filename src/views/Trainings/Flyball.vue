  ...
  <div class="fetch-training">
    <div class="title-box">
      ...
      <div class="content">
        ...
        <ol>
          <li><strong>Start in a Small Space:</strong> Introduce the game in a distraction-free area.</li>
          <li>
            <strong>Combine with Come and Drop Commands:</strong>
            <ul>
              <li><strong>Dog Doesn’t Return the Ball:</strong> Use the "come" command in an engaging way.</li>
              <li><strong>Dog Won’t Drop the Ball:</strong> Trade the ball for a treat while saying "drop".</li>
            </ul>
          </li>
          <li><strong>Repetition:</strong> Repeat consistently so the dog associates fetch with fun.</li>
        </ol>
