    ...
    <div class="title-box">
      ...
      <div class="content">
        ...
        <ol>
          ...
          <li><strong>Positioning Your Dog:</strong> Have your dog sit in front of you, and spread your legs apart.</li>
          <li><strong>Drop Your Right Hand:</strong> Place both hands behind your back and then drop your right hand between your legs.</li>
          <li><strong>Lure Your Dog Through Your Legs:</strong> When the dog touches your right hand, pull it through your left leg and give the dog a treat.</li>
          <li><strong>Repeat with Left Hand:</strong> Return both hands behind your back and drop your left hand between your legs. When the dog touches your left hand, pull it through your right leg and reward them.</li>
          <li><strong>Practice Without Food:</strong> After your dog understands the concept, start practicing without food in your hand. Use the <strong>hand target</strong> only to guide them through your legs.</li>
          <li><strong>Be Patient and Consistent:</strong> As with any dog training, patience and consistency are key. Don’t get discouraged if your dog takes time to understand the trick.</li>
        </ol>
