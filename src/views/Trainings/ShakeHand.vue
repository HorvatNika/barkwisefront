  ...
  <div class="shake-hand">
    <div class="title-box">
      ...
      <div class="content">
        ...
        <ol>
          <li><strong>Start with the Sit Command:</strong> Have your dog sit in front of you.</li>
          <li><strong>Hold a Treat in Your Hand:</strong> Hold a treat in a closed fist, lowered halfway between the dog’s head and the floor.</li>
          <li><strong>Wait for a Reaction:</strong> Do not lift the dog’s paw or push them. Wait for the dog to try to reach the treat.</li>
          <li><strong>Reward and Encourage:</strong> As soon as the dog raises their paw, even if it doesn't touch your hand, say <strong>yes</strong> and give them the treat.</li>
          <li><strong>Repeat and Introduce a Command:</strong> Once the dog consistently raises their paw, introduce the command <strong>shake hands</strong> or <strong>give paw</strong>.</li>
          <li><strong>Raise the Criteria:</strong> Gradually raise your hand with the treat so the dog has to lift their paw higher to touch it.</li>
          <li><strong>Reinforce the Trick:</strong> Start reducing the frequency of treats as the dog reliably responds.</li>
        </ol>
        ...
        <div class="video-container">
          <iframe 
            width="560" 
            height="315" 
            src="https://www.youtube.com/embed/7Edd0dWLpTk" 
            frameborder="0" 
