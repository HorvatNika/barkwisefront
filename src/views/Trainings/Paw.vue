  ...
  <div class="paw">
    <div class="title-box">
      ...
      <div class="content">
        ...
        <ol>
          <li><strong>Hold a Treat in Your Hand:</strong> Show the treat to your dog, then close your hand into a fist.</li>
          <li><strong>Wait for Your Dog to Touch Your Hand with Their Paw:</strong> Be patient and let the dog figure it out.</li>
          <li><strong>Mark the Behavior and Reward:</strong> When the dog touches your hand, say <strong>paw</strong> and reward.</li>
          <li><strong>Gradually Reduce Treats:</strong> Begin rewarding less frequently, using praise or petting as alternatives.</li>
          <li><strong>Practice in Different Environments:</strong> Train the command in various settings to generalize the behavior.</li>
        </ol>
        ...
        <p><strong>Some dogs may not like having their paws touched. If your dog shows signs of discomfort, stop and try a different method.</strong></p>
      </div>
    </div>
