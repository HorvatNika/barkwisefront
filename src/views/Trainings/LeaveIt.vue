<template>
  <div class="leave-it">
    <div class="title-box">
      <div class="page-title">leave it</div>
      <div class="content">
        <h2>Teaching Your Dog the Leave It Command</h2>
        <ol>
          <li><strong>Set Up the Scenario:</strong> Find distractions outdoors - these can be toys, food, paper, or other dogs. Keep the dog on a leash to prevent access to the distraction.</li>
          <li><strong>Walk and Spot the Distraction:</strong> Walk with your dog towards the distraction. As soon as the dog notices it and moves towards it, clearly and firmly say <strong>leave it.</strong></li>
          <li>
            <strong>Respond to the Dog's Reaction:</strong> The dog may react in two ways:
            <ul>
              <li><strong>Ignores the Command:</strong> If the dog continues towards the distraction, gently pull the leash to stop them and immediately reward them with a treat when they turn towards you.</li>
              <li><strong>Obeys the Command:</strong> If the dog obeys and turns to you right away, reward them immediately with a treat.</li>
            </ul>
          </li>
          <li><strong>Repeat and Reward:</strong> Repeat the process with different distractions. Consistency is key, always use the <strong>leave it</strong> command when you want your dog to ignore something.</li>
          <li><strong>Gradually Reduce Treats:</strong> Once your dog reliably responds to the command, gradually decrease the frequency of treats, giving them only occasionally.</li>
        </ol>
