        ...
        <div class="content">
          ...
          <ol>
            ...
            <li>
              ...
              <ul>
                <li>
                  <strong>Ignores the Command:</strong> If the dog continues towards the distraction, gently pull the leash to stop them and immediately reward them with a treat when they turn towards you.
                </li>
                <li>
                  <strong>Obeys the Command:</strong> If the dog obeys and turns to you right away, reward them immediately with a treat.
                </li>
              </ul>
            </li>
            <li>
              <strong>Repeat and Reward:</strong> Repeat the process with different distractions. Consistency is key, always use the <strong>leave it</strong> command when you want your dog to ignore something.
            </li>
            <li>
              <strong>Gradually Reduce Treats:</strong> Once your dog reliably responds to the command, gradually decrease the frequency of treats, giving them only occasionally.
            </li>
          </ol>
