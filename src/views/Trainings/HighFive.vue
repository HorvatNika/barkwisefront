<template>
  <div class="high-five">
    <div class="title-box">
      <div class="page-title">high five</div>
      <div class="content">
        <h2>Teaching Your Dog to Give a High Five</h2>
        <ol>
          <li><strong>Assumption:</strong> The dog already knows how to give a paw. This technique is based on the <strong>paw</strong> trick, so it's important that your dog already knows this.</li>
          <li><strong>Offer Your Hand in an Upright Position:</strong> Instead of offering your hand for the <strong>paw</strong> trick, hold it upright, as if you’re going to give someone a <strong>high five</strong>.</li>
          <li><strong>Praise and Reward:</strong> The moment the dog touches your hand with its paw, say <strong>yes</strong> or <strong>good job</strong> and immediately give a treat.</li>
          <li><strong>Introduce the Command:</strong> When the dog consistently touches your hand in the high five position, begin saying the command <strong>high five</strong> before offering your hand.</li>
        </ol>
        ...
        <div class="video-container">
          <iframe 
            width="560" 
            height="315" 
            src="https://www.youtube.com/embed/wyv2dN1_Yv8" 
            frameborder="0" 
