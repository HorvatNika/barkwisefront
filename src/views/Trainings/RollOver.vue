<template>
  <div class="roll-over">
    <div class="title-box">
      <div class="page-title">roll over</div>
      <div class="content">
        <h2>Teaching Your Dog to Roll Over</h2>
        <ol>
          <li><strong>Lure the Dog into a Lying Position:</strong> Using a treat in your hand, guide your dog to lie down.</li>
          <li><strong>Place the Dog on Their Side:</strong> Hold the treat near the dog’s nose and gently lift their head so their weight shifts onto their side. Reward them when they are on their side.</li>
          <li><strong>Guide the Dog Further:</strong> With the treat near their nose, lead the dog’s head upwards toward the side that’s facing up. Gently guide them to roll onto their back.</li>
          <li><strong>Complete the Roll:</strong> Hold the treat away from the dog so they must fully roll over to reach it.</li>
          <li><strong>Repeat and Add a Command:</strong> Repeat the process, adding a command like <strong>roll over</strong> or a similar word of your choice as the dog begins to roll.</li>
        </ol>
        ...
        <div class="video-container">
          <iframe 
            width="560" 
            height="315" 
            src="https://www.youtube.com/embed/5_3ceZ9mSrk" 
            frameborder="0" 
    ...
    async updateComment(_id) {
      ...
      try {
        const res = await axios.put(
          `https://barkwisebackend.onrender.com/${_id}`,
          { text: this.editText },
          { headers: { Authorization: `Bearer ${token}` } }
        );
